...
import ooad.timewise.databinding.RingViewBinding;
...
public class RingActivity extends AppCompatActivity {
    ...
    private RingViewBinding ringViewBinding;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        ringViewBinding = RingViewBinding.inflate(getLayoutInflater());
        setContentView(ringViewBinding.getRoot());
        ...
        ringViewBinding.activityRingDismiss.setOnClickListener(v -> dismissAlarm());

        ringViewBinding.activityRingSnooze.setOnClickListener(v -> snoozeAlarm());

        animateClock();
    }

    private void animateClock() {
        ObjectAnimator rotateAnimation = ObjectAnimator.ofFloat(ringViewBinding.activityRingClock, "rotation", 0f, 30f, 0f, -30f, 0f);
